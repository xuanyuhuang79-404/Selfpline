...
CREATE TABLE IF NOT EXISTS ai_custom_plan (
    ...
    end_date DATE,
    status TINYINT DEFAULT 1 COMMENT '0-废弃/删除 1-执行中 2-已完成 3-已结束',
    created_at DATETIME DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS health_daily_record (
    ...
    exercise_minutes INT COMMENT '锻炼时长(分钟)',
    mood_level TINYINT COMMENT '心情状态 1-5',
    energy_level TINYINT COMMENT '精力状态 1-5',
    stress_level TINYINT COMMENT '压力状态 1-5',
    created_at DATETIME DEFAULT CURRENT_TIMESTAMP,
